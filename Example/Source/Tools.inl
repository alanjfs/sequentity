...
const Tool TranslateTool2() {
    Tool t; {
        t.type = ToolType::Translate;
        t.write = TranslateTool;
        t.read = [](entt::entity entity, const Sequentity::Event& event, const int time) {
...
const Tool RotateTool2() {
    Tool t; {
        t.type = ToolType::Rotate;
        t.write = RotateTool;
        t.read = [](entt::entity entity, const Sequentity::Event& event, const int time) {
...
const Tool ScaleTool2() {
    Tool t; {
        t.type = ToolType::Scale;
        t.write = ScaleTool;
        t.read = [](entt::entity entity, const Sequentity::Event& event, const int time) {
